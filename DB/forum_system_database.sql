...
-- Dumping data for table forum_system.comments: ~4 rows (approximately)
...
-- Dumping structure for table forum_system.likes
...
-- Dumping data for table forum_system.likes: ~10 rows (approximately)
...
INSERT INTO `posts` (`id`, `title`, `content`, `likes`, `user_id`, `date_created`) VALUES
                                                                                       (1, 'Old times', 'Once upon a time there was a...', 1, 2, '2023-02-01 12:12:10'),
                                                                                       (2, 'Ice and Fire', 'They were destroying everything on their path...', 0, 2, '2023-02-04 12:12:59'),
                                                                                       (3, 'Self observation', 'This practice requires your full attention to details', 3, 4, '2023-01-01 12:14:25'),
                                                                                       (4, 'Batman quotes', 'The night is darkest just before the dawn', 2, 3, '2023-02-21 12:14:51'),
                                                                                       (5, 'Batman quotes', 'Your anger gives you great power', 2, 3, '2023-02-21 12:16:20'),
                                                                                       (6, 'Learn Java in no time', 'You can start from Oracle documentation, then take some Udemy courses, then start practicing... ', 1, 8, '2023-01-21 12:20:42'),
                                                                                       (7, 'Test title goes here', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 1, 4, '2023-01-10 12:26:34');
...
-- Dumping data for table forum_system.posts_tags: ~4 rows (approximately)
...
-- Dumping data for table forum_system.tags: ~3 rows (approximately)
...
-- Dumping data for table forum_system.users: ~8 rows (approximately)
