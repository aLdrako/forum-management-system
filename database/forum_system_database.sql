...
-- Dumping data for table forum_system.comments: ~9 rows (approximately)
...
-- Dumping data for table forum_system.likes: ~12 rows (approximately)
...
-- Dumping data for table forum_system.phones: ~0 rows (approximately)
...
-- Dumping data for table forum_system.posts: ~13 rows (approximately)
...
-- Dumping data for table forum_system.posts_tags: ~18 rows (approximately)
...
-- Dumping data for table forum_system.tags: ~23 rows (approximately)
